...
describe('array_switch_modulator', function() {
	...
	it('propagates arrayness', function() {
		...
		//var floatReadNode = E2.app.instantiatePlugin('float_display')
		var pullerNode = E2.app.instantiatePlugin('float_display')

		function connect(a, aidx, b, bidx, dyn) {
		...
		connect(floatNode1, 0, inputsToArrayNode1, 0, true)
		connect(floatNode2, 0, inputsToArrayNode1, 1, true)

		connect(floatNode2, 0, inputsToArrayNode2, 0, true)
		connect(floatNode3, 0, inputsToArrayNode2, 1, true)
		...
		var arrayConn1 = connect(inputsToArrayNode1, 0, arraySwitchModulator, 0, true)
		var arrayConn2 = connect(inputsToArrayNode2, 0, arraySwitchModulator, 1, true)

		floatNode1.plugin.state.val = 10
		floatNode2.plugin.state.val = 20
		floatNode3.plugin.state.val = 30

		connect(arraySwitchModulator, 1, pullerNode, 0)
		...
		var floatConn1 = connect(floatNode1, 0, arraySwitchModulator, 0, true)
		var floatConn2 = connect(floatNode2, 0, arraySwitchModulator, 1, true)
