E2.p = E2.plugins["triangle_modulator"] = function(core, node)
{
	...
	this.input_slots = [
		{ name: 'time', dt: core.datatypes.FLOAT, desc: 'The current time in seconds.', def: 0 }
	];
	
	this.output_slots = [
		{ name: 'value', dt: core.datatypes.FLOAT, desc: 'Emits ((0.5 - |(<b>time</b> % 1.0) - 0.5|) - 0.25) * 4.', def: 0 }
	];
};
