	...
	switch(message.kind) {
		...
		default:
			if (message.actionType) {
				...
				that.sendToChannel(message.channel, message, client.id)
			}
...
EditorChannelServer.prototype.saveEdit = function(message) {
	return new EditLog({
...
EditorChannelServer.prototype.sendEdits = function(channelName, client) {
	var that = this
	var count = 0 
...
EditorChannelServer.prototype.joinChannel = function(channelName, client) {
	...
	this.sendEdits(channelName, client)
}
