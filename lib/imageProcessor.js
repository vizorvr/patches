...
ImageProcessor.prototype._handleProfileImageUpload = function(file, destDir, width, height, gravity) {
	var that = this
	...
	.then(function(oinfo) {
		info.original = oinfo
		return that.createScaled(normalizedPath, width, height, gravity)
	})
	// analyse and store
...
ImageProcessor.prototype.handleUserAvatarUpload = function(file, destDir) {
	return this._handleProfileImageUpload(file, destDir, 128, 128, this.defaultGravity)
}
ImageProcessor.prototype.handleUserHeaderUpload = function(file, destDir) {
	return this._handleProfileImageUpload(file, destDir, 1440, 340, this.defaultGravity)
}

ImageProcessor.prototype.createScaled = function(path, width, height, gravity) {
	var dfd = when.defer()
...
ImageProcessor.prototype.normalizeImage = function(path) {
	...
	var usableTypes = ['.jpg', '.jpeg', '.png', '.gif']
